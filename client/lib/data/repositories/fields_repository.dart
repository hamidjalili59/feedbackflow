...
abstract class FieldsRepository {
  Future<FormFieldDto> createFormField({
    required String id,
    required CreateFormFieldRequest request,
  });
  Future<DeleteResultDto> deleteFormField({
    required String id,
    required String fieldId,
  });
  Future<FormFieldDto> updateFormField({
    required String id,
    required String fieldId,
...
class DioFieldsRepository implements FieldsRepository {
  ...
  Future<FormFieldDto> createFormField({
    ...
    return EnvelopeGuard.data(
      await _api.createFormField(id: id, request: request),
    );
  }
  ...
  Future<DeleteResultDto> deleteFormField({
    ...
    return EnvelopeGuard.data(
      await _api.deleteFormField(id: id, fieldId: fieldId),
    );
  }
  ...
  Future<FormFieldDto> updateFormField({
    ...
    return EnvelopeGuard.data(
      await _api.updateFormField(id: id, fieldId: fieldId, request: request),
    );
  }
}
