...
class PermissionDtoMapper {
  ...
  static EffectivePermissionEntity toEntity(EffectivePermissionsDto dto) =>
      EffectivePermissionEntity(
        userId: dto.userId,
  ...
  static EffectivePermissionEntity toDomain(EffectivePermissionsDto dto) =>
      toEntity(dto);
}
