...
class FormDtoMapper {
  ...
  static FormSummaryEntity summaryToEntity(FormSummaryDto dto) =>
      FormSummaryEntity(
        id: dto.id,
  ...
  static FormSummaryEntity summaryToDomain(FormSummaryDto dto) =>
      summaryToEntity(dto);
  ...
  static FormDetailEntity detailToDomain(FormDetailDto dto) =>
      detailToEntity(dto);
  ...
  static PublicFormEntity publicToDomain(PublicFormDto dto) =>
      publicToEntity(dto);
}
